...
<% 
    ...
    String mail = "", fname = "", lname = "", pwod = ""; int type1 = 0; String uuid = "";
    ...
    <body>
        ...
        <main>
            ...
            <form action="clerk" method="POST" id="formy">
                ...
                <input type="range" id="userrole" name="userrole" value="<%= type1 %>" min="0" max="2" required/>
